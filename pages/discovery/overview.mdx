---
title: Predexa Discovery API
description: Find events and normalized markets across venues, then resolve or match native IDs to canonical IDs.
---

# Predexa Discovery API

Use Predexa Discovery to find events and normalized markets across venues, then resolve or match venue-native IDs to canonical IDs.
