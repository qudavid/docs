...
| **Field names** | Polymarket: event `slug`, market `slug`; Kalshi: `event_ticker`, `ticker` | Unified field structure with `venue_ids{}` |
...
| **Polymarket Market Slug** | `will-yankees-win` | Polymarket API |
